...
export const Navbar: React.FC<NavbarProps> = ({ activeSection }) => {
  ...
  // Shrink the mobile island pill once the user has scrolled down
  const isShrunk = scrolled;

  // Capitalize first letter of active section for label
  ...
  return (
    <>
      ...
      {/* MOBILE BLACK iPHONE DYNAMIC ISLAND NAVBAR (Global — visible on every section) */}
      <motion.div
          ...
          >
            ...
            <div className="flex items-center gap-1.5">
              ...
              <span className="font-bold tracking-wider text-white font-mono">
                {isShrunk ? sectionLabel : 'NAVEEN.DEV'}
              </span>
            </div>
            ...
            <div className="flex items-center justify-between pb-2 border-b border-slate-800">
              <div className="flex items-center gap-2">
                ...
                <span className="font-bold text-xs tracking-wider text-white font-mono">
                  <span className="text-cyan-400">{sectionLabel}</span>
                </span>
              </div>
