...
export const SkillsSection: React.FC<SkillsSectionProps> = ({ onSelectSkill }) => {
  ...
  return (
    ...
    >
      ...
      <motion.div
        className="absolute top-10 right-1/4 w-[450px] h-[450px] bg-blue-500/8 rounded-full blur-[140px] pointer-events-none"
        style={{ y: orbY, willChange: 'transform' }}
      />
      <motion.div
        className="absolute bottom-10 left-1/4 w-[420px] h-[420px] bg-purple-500/8 rounded-full blur-[140px] pointer-events-none"
